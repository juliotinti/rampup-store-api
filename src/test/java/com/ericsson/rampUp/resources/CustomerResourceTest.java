...
import com.ericsson.rampUp.services.TicketService;
import com.ericsson.rampUp.services.exceptions.AddressException;
import com.ericsson.rampUp.services.exceptions.CustomerAlreadyExists;
import com.ericsson.rampUp.services.exceptions.IdNullException;
import com.ericsson.rampUp.services.exceptions.NoValueForIdException;
import com.ericsson.rampUp.services.exceptions.ResourceNotFoundException;
import com.ericsson.rampUp.services.exceptions.UnexpectedException;
...
public class CustomerResourceTest {
    ...
    private com.ericsson.rampUp.entities.Order orderTest1;
    private com.ericsson.rampUp.entities.Order orderTest2;
    ...
    public void setup() throws Exception {
        ...
        orderTest1 = new com.ericsson.rampUp.entities.Order(1, Instant.parse("2022-06-20T19:53:07Z"), customerTest1,
                customerTest1.getAddresses().get(0));
        orderTest2 = new com.ericsson.rampUp.entities.Order(2, Instant.now(), customerTest1,
                customerTest1.getAddresses().get(0));
    ...
    public void findAllOrdersByCustomerId_thenReturnAllCustomerOrders() throws Exception {
        // set up
        List<com.ericsson.rampUp.entities.Order> customerTest1Orders = List.of(orderTest1, orderTest2);
